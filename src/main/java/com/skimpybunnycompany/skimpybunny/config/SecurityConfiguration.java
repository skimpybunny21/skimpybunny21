...
import com.skimpybunnycompany.skimpybunny.security.*;
import com.skimpybunnycompany.skimpybunny.security.SecurityUtils;
import com.skimpybunnycompany.skimpybunny.security.oauth2.AudienceValidator;
import com.skimpybunnycompany.skimpybunny.security.oauth2.CustomClaimConverter;
import com.skimpybunnycompany.skimpybunny.security.oauth2.JwtGrantedAuthorityConverter;
import java.util.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            .csrf().disable()
/* uncomment lines below if you want to enable csrf */
//            .csrf()
